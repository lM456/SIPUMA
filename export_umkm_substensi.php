...
// Ambil semua data UMKM level 1 (Substensi)
$sql = "SELECT * FROM umkm WHERE level_umkm = 1 ORDER BY created_at DESC";
$result = mysqli_query($conn, $sql);

// Header untuk download sebagai Excel
$filename = "umkm_substensi_" . date('Y-m-d') . ".xls";
...
if ($result && mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // Format angka untuk kenyamanan melihat; jika ingin angka mentah, hapus "Rp " dan number_format
