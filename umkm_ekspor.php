...
$sql = "SELECT * FROM umkm WHERE level_umkm = 4 ORDER BY created_at DESC LIMIT $start, $limit";
$result = mysqli_query($conn, $sql);

// Hitung total untuk pagination
$countSql = "SELECT COUNT(*) AS total FROM umkm WHERE level_umkm = 4";
$countResult = mysqli_query($conn, $countSql);
$total = mysqli_fetch_assoc($countResult)['total'];
$total_pages = ceil($total / $limit);

$kategori = "UMKM Ekspor";
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<div class="card">
    <a href="export_umkm_ekspor.php" class="export-btn">Export ke Excel</a>
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>
                            ...
                            <td>
                                <a href='editdata.php?id={$row['id']}&redirect=umkm_ekspor.php' class='btn btn-edit'>Edit</a>
