...
<div class="card">
    <a href="export_<?= strtolower(str_replace(' ', '_', $kategori)); ?>.php" class="export-btn">Export ke Excel</a>
    <a href="javascript:history.back()" class="export-btn back-btn">Kembali</a>
