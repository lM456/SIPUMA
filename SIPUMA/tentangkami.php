...
<body>
    ...
    <header>
        ...
        <div>
            <a href="profil.html">
                <img src="img/avatardefault_92824.png" alt="User Icon" width="30" style="cursor:pointer;">
            </a>
        </div>
    </header>
    ...
    <section class="about">
        <div class="photo-gallery">
            <img src="img/foto1.png" alt="Foto UMKM 1">
            <img src="img/foto2.png" alt="Foto UMKM 2">
            <img src="img/foto3.png" alt="Foto UMKM 3">
        </div>
